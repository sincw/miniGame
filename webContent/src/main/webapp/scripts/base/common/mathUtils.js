define(["require", "exports", "utils", "jquery"], function (require, exports, utils) {
    "use strict";
    //常用阶乘数据
    exports.cantorConst = [1, 1, 2, 6, 24, 120, 720, 5040, 40320, 362880];
    /**
    * 返回阶乘
    * @exapmle
    ...
    */
    function cantor(arr) {
        var fconst = exports.cantorConst;
    ...
    */
    ...
    exports.squaMDistance = squaMDistance;
    /**
    * 返回矩形的曼哈顿距离.
    * @exapmle
    * require(["mathUtils"],function(utils){
    ...
    * @date 2018-03-24
    */
    function squaArrMDistance(s1, colsize) {
        var arr = sliceArr(s1, colsize);
        return squaMDistance(arr);
    }
    exports.squaArrMDistance = squaArrMDistance;
    /**
    * 将数组用洗牌算法随机打乱.
    * @exapmle
    * require(["mathUtils"],function(utils){
